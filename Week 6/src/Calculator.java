...
public class Calculator {
	public static void main(String[] args)
	{
		int ch=0;
		  ...
		  ch=scan.nextInt();//Am i missing a option here?
		  switch (ch)
		  {
		  case 1 : 
		  ...
		  case 6:
			  ...
			  break;
		  case 7:
			  System.out.println(varance(first,second));
		  }
	}
	...
	private static double varance(double a, double b){
		return (a-(a/(a+b))*(a-(a/(a+b))+(b-(b/(a+b)))))*(b-(b/(a+b)))/(a+b);
	}
